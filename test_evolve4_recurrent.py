...
print("\n-- Evolving Weights and Recurrent --")

neuro = NeuroEvolution(layer_nodes=[10, 10, 10], num_input=6, num_output=1, default_layer_activation='relu')
neuro.evolve(input=x_train, expected_output=y_train, error_function='mse', max_generations=15,
             evolve_recurrent_layer=['tanh', 'logistic', 'relu'], max_gen_size=500)
...
print("\n-- Evolving Weights,Links,Recurrent With Different Layer Activation Function --")

neuro = NeuroEvolution(layer_nodes=[10, 10, 10], num_input=6, num_output=1, default_layer_activation=['relu','logistic','tanh'])
neuro.evolve(input=x_train, expected_output=y_train, error_function='mse', max_generations=15,evolve_links=True,
             evolve_recurrent_layer=['tanh', 'logistic', 'relu'],  max_gen_size=500)
