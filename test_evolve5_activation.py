...
print("\n-- Evolving Weights and Layer Activation Function --")
...
print("\n-- Evolving Weights, Links, and Layer Activation --")

neuro = NeuroEvolution(layer_nodes=[10, 10, 10], num_input=6, num_output=1)
